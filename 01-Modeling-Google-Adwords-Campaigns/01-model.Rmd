...
TODO: conclusión
http://stats.stackexchange.com/questions/210217/how-do-i-interpret-these-results-from-a-paired-t-test
...
- Realizaremos un análisis descriptico para tratar de explicar que cursos funcionan mejor que otros.
...
##TODO hacer primero limpieza y separación de campañas
...
Son NA generados por la ausencia de datos en el dataset `costes_por_campana`. Podemo omitirlos:
